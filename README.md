...
> *Note*: the methods described here (v9) are a little different than the published research (v8) because I wanted to test a slightly different approach for projections. However, no difference was observed.
